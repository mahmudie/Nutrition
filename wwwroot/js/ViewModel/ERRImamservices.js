function ErrImamservicesForm(model) {
    ...
    self.edit = function (item) {
        ...
        self.form.Cures(item.cures);
        self.form.Deaths(item.deaths);
        self.form.Defaulters(item.defaulters);
        self.form.Referouts(item.referouts);

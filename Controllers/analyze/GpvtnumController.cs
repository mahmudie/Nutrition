...
{
    public class GpvtnumController : Controller
    {
        private readonly WebNutContext _context;
        private readonly IHostingEnvironment _hostingEnvironment;

        public GpvtnumController(WebNutContext context, IHostingEnvironment hostingEnvironment)
        {
            _context = context;
        ...
        {
            return _hostingEnvironment.WebRootPath + "//analysis//" + fileName;
                ...
                case 1:
                    {
                        ...
                        var data = _context.totalpivotcombinednprovs.ToList();
                        ...
                        IPivotField TotalCases = pivotTable.Fields["Num"];

                        pivotTable.DataFields.Add(TotalCases, "Total Cases", PivotSubtotalTypes.Sum);
                        ...
                        //if (System.IO.File.Exists(ResolveApplicationPath("Nutrition_Provincial.xlsx")))
                        //{
                        //    try
                        //    {
                        //        System.GC.Collect();
                        //        System.GC.WaitForPendingFinalizers();
                        //        System.IO.File.Delete(ResolveApplicationPath("Nutrition_Provincial.xlsx"));
                        //    }
                        //    catch (Exception e) { }
                        //}
                        ...
                        //MemoryStream ms = new MemoryStream();
                        //FileStream outputStream = new FileStream(ResolveApplicationPath("Nutrition_Provincial.xlsx"), FileMode.Create);
                        ...
                        //workbook.Close();
                        //excelEngine.Dispose();
                        //return RedirectToAction("PPivotView");
                ...
                case 2:
                    {
                        ...
                        var data = _context.totalpivotcombinednprovm.ToList();
                ...
                case 1:
                    {
                        ...
                        var data = _context.totalpivotcombinedndists.ToList();
                ...
                case 2:
                    {
                        ...
                        var data = _context.totalpivotcombinedndistm.ToList();
        ...
        public IActionResult HPivot([Bind("Province,DistCode,Facility,Calendar,Period")]IndicatorsFilter req)
        {
            ...
            switch (Calendar)
            {
                case 1:
                    {
                        ...
                        var data = _context.totalpivotcombinednhfs.ToList();
                ...
                case 2:
                    {
                        _context.Database.SetCommandTimeout(5000);
                        var data = _context.totalpivotcombinednhfm.ToList();
